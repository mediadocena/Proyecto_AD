--------------------------------------------------------
-- Archivo creado  - lunes-octubre-21-2019   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Type DIRECCION
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."DIRECCION" AS OBJECT(
CALLE VARCHAR2(25),
CIUDAD VARCHAR2(20),
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."LIBRO" AS OBJECT(
COD_LIBRO NUMBER,
CLASE NUMBER,
PRESTADO NUMBER(1),
GENERO VARCHAR2(20),
...
/
--------------------------------------------------------
--  DDL for Type PERSONA
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TYPE "SYSTEM"."PERSONA" AS OBJECT(
NUM_CARNET NUMBER,
NOMBRE VARCHAR2(20),
DIREC DIRECCION,
...
MEMBER FUNCTION GET_DIREC RETURN DIRECCION
 ...
 ALTER TYPE "SYSTEM"."PERSONA" ADD ATTRIBUTE PENALIZADO NUMBER(1) CASCADE

/
--------------------------------------------------------
--  DDL for Sequence AUTOHISTORICO
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."AUTOHISTORICO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 81 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence AUTOLIBRO
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."AUTOLIBRO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence AUTOPRESTAMO
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."AUTOPRESTAMO"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 141 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence AUTOUSER
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."AUTOUSER"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 81 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."HISTORICO" 
   (	"ID" NUMBER, 
	"USUARIO" "SYSTEM"."PERSONA" , 
	"LIBRO" "SYSTEM"."LIBRO" , 
	"FECHA_INICIO" DATE, 
	"FECHA_FIN" DATE, 
	"PLAZO" DATE
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LIBROS" OF "SYSTEM"."LIBRO" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."PRESTAMOS" 
   (	"ID" NUMBER, 
	"USUARIO" REF "SYSTEM"."PERSONA" , 
	"LIBRO" REF "SYSTEM"."LIBRO" , 
	"FECHA_INICIO" DATE, 
	"FECHA_FIN" DATE, 
	"PLAZO" DATE, 
	SCOPE FOR ("USUARIO") IS "SYSTEM"."USUARIOS" , 
	SCOPE FOR ("LIBRO") IS "SYSTEM"."LIBROS" 
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."USUARIOS" OF "SYSTEM"."PERSONA" 
 OIDINDEX  ( PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
REM INSERTING into SYSTEM.HISTORICO
SET DEFINE OFF;
Insert into SYSTEM.HISTORICO (ID,USUARIO,LIBRO,FECHA_INICIO,FECHA_FIN,PLAZO) values ('1',SYSTEM.PERSONA(3, 'ANTONIO', SYSTEM.DIRECCION('PEÑA', 'SEVILLA', 41701), 0),SYSTEM.LIBRO(23, 2, 0, 'TERROR', 'H.P LOVECRAFT', 'LA SOMBRA SOBRE...', 'PROFUNDOS'),to_date('05/05/19','DD/MM/RR'),null,to_date('06/06/19','DD/MM/RR'));
Insert into SYSTEM.HISTORICO (ID,USUARIO,LIBRO,FECHA_INICIO,FECHA_FIN,PLAZO) values ('2',SYSTEM.PERSONA(3, 'ANTONIO', SYSTEM.DIRECCION('PEÑA', 'SEVILLA', 41701), 0),SYSTEM.LIBRO(23, 2, 0, 'TERROR', 'H.P LOVECRAFT', 'LA SOMBRA SOBRE...', 'PROFUNDOS'),to_date('05/05/19','DD/MM/RR'),null,to_date('06/06/19','DD/MM/RR'));
Insert into SYSTEM.HISTORICO (ID,USUARIO,LIBRO,FECHA_INICIO,FECHA_FIN,PLAZO) values ('21',SYSTEM.PERSONA(3, 'ANTONIO', SYSTEM.DIRECCION('PEÑA', 'SEVILLA', 41701), 1),SYSTEM.LIBRO(20, 2, 0, 'TERROR', 'H.P LOVECRAFT', 'LA SOMBRA SOBRE...', 'PROFUNDOS'),to_date('04/04/19','DD/MM/RR'),to_date('24/04/19','DD/MM/RR'),to_date('05/05/19','DD/MM/RR'));
Insert into SYSTEM.HISTORICO (ID,USUARIO,LIBRO,FECHA_INICIO,FECHA_FIN,PLAZO) values ('41',SYSTEM.PERSONA(41, 'Alejandro', SYSTEM.DIRECCION('Verdiales', 'Dos Hermanas', 41702), 0),SYSTEM.LIBRO(19, 1, 0, 'MISTERIO', 'H.P LOVECRAFT', 'HORROR DE DUNWICH', 'PROFUNDOS'),to_date('20/10/19','DD/MM/RR'),to_date('30/10/19','DD/MM/RR'),to_date('11/11/19','DD/MM/RR'));
Insert into SYSTEM.HISTORICO (ID,USUARIO,LIBRO,FECHA_INICIO,FECHA_FIN,PLAZO) values ('42',SYSTEM.PERSONA(61, 'Joaquin', SYSTEM.DIRECCION('Cin', 'Sevilla', 41704), 1),SYSTEM.LIBRO(21, 2, 0, 'Horror', 'Stephen K.', 'La niebal', 'HorrorEdits'),to_date('05/05/19','DD/MM/RR'),to_date('25/05/19','DD/MM/RR'),to_date('06/06/19','DD/MM/RR'));
Insert into SYSTEM.HISTORICO (ID,USUARIO,LIBRO,FECHA_INICIO,FECHA_FIN,PLAZO) values ('43',SYSTEM.PERSONA(66, 'Jacinto', SYSTEM.DIRECCION('España', 'Dos Hermanas', 41702), 0),SYSTEM.LIBRO(20, 2, 0, 'TERROR', 'H.P LOVECRAFT', 'LA SOMBRA SOBRE...', 'PROFUNDOS'),to_date('20/10/19','DD/MM/RR'),to_date('09/11/19','DD/MM/RR'),null);
REM INSERTING into SYSTEM.LIBROS
SET DEFINE OFF;
Insert into SYSTEM.LIBROS (COD_LIBRO,CLASE,PRESTADO,GENERO,AUTOR,TITULO,EDITOR) values ('19','1','1','MISTERIO','H.P LOVECRAFT','HORROR DE DUNWICH','PROFUNDOS');
Insert into SYSTEM.LIBROS (COD_LIBRO,CLASE,PRESTADO,GENERO,AUTOR,TITULO,EDITOR) values ('20','2','0','TERROR','H.P LOVECRAFT','LA SOMBRA SOBRE...','PROFUNDOS');
Insert into SYSTEM.LIBROS (COD_LIBRO,CLASE,PRESTADO,GENERO,AUTOR,TITULO,EDITOR) values ('21','2','0','Horror','Stephen K.','La niebal','HorrorEdits');
Insert into SYSTEM.LIBROS (COD_LIBRO,CLASE,PRESTADO,GENERO,AUTOR,TITULO,EDITOR) values ('41','3','0','Informatica','Alejandro','Python','Mi Editor');
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.PRESTAMOS
SET DEFINE OFF;
Insert into SYSTEM.PRESTAMOS (ID,USUARIO,LIBRO,FECHA_INICIO,FECHA_FIN,PLAZO) values ('121','SYSTEM.PERSONA(41, ''Alejandro'', SYSTEM.DIRECCION(''Verdiales'', ''Dos Hermanas'', 41702), 0)','SYSTEM.LIBRO(20, 2, 0, ''TERROR'', ''H.P LOVECRAFT'', ''LA SOMBRA SOBRE...'', ''PROFUNDOS'')',to_date('21/10/19','DD/MM/RR'),to_date('10/11/19','DD/MM/RR'),null);
...
SET DEFINE OFF;
Insert into SYSTEM.USUARIOS (NUM_CARNET,NOMBRE,DIREC,PENALIZADO) values ('41','Alejandro',SYSTEM.DIRECCION('Verdiales', 'Dos Hermanas', 41702),'0');
Insert into SYSTEM.USUARIOS (NUM_CARNET,NOMBRE,DIREC,PENALIZADO) values ('3','ANTONIO',SYSTEM.DIRECCION('PEÑA', 'SEVILLA', 41701),'0');
Insert into SYSTEM.USUARIOS (NUM_CARNET,NOMBRE,DIREC,PENALIZADO) values ('61','Joaquin',SYSTEM.DIRECCION('Cin', 'Sevilla', 41704),'1');
Insert into SYSTEM.USUARIOS (NUM_CARNET,NOMBRE,DIREC,PENALIZADO) values ('63','Jaime',SYSTEM.DIRECCION('Puerta', 'Sevilla', 41703),'0');
Insert into SYSTEM.USUARIOS (NUM_CARNET,NOMBRE,DIREC,PENALIZADO) values ('65','Jose',SYSTEM.DIRECCION('Piña', 'Madrid', 14700),'0');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSAUX" ;
--------------------------------------------------------
--  DDL for Trigger RECUPERAR_HISTORICO
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE TRIGGER "SYSTEM"."RECUPERAR_HISTORICO" AFTER DELETE ON PRESTAMOS
FOR EACH ROW
BEGIN
...
END;
/
ALTER TRIGGER "SYSTEM"."RECUPERAR_HISTORICO" ENABLE;
--------------------------------------------------------
--  DDL for Procedure ACTUALIZAR_LIBROS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."ACTUALIZAR_LIBROS" (ID NUMBER,CLAS NUMBER,PRES NUMBER,GEN VARCHAR2,AUT VARCHAR2,TITUL VARCHAR2,EDITO VARCHAR2)IS
BEGIN
UPDATE LIBROS SET 
   CLASE= CLAS  ,
   PRESTADO=PRES ,
...
/
--------------------------------------------------------
--  DDL for Procedure ACTUALIZAR_USUARIOS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."ACTUALIZAR_USUARIOS" (ID NUMBER,NOM VARCHAR2,CALLE VARCHAR2,CIUDAD VARCHAR2,COD_POST NUMBER,PENALIZADO NUMBER)IS
BEGIN
   UPDATE USUARIOS SET 
   NOMBRE = NOM,
...
/
--------------------------------------------------------
--  DDL for Procedure BORRAR_LIBROS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."BORRAR_LIBROS" (ID NUMBER)IS
BEGIN
...
/
--------------------------------------------------------
--  DDL for Procedure BORRAR_PRESTAMOS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."BORRAR_PRESTAMOS" (IDENT NUMBER)IS
B NUMBER;
C NUMBER;
FECHA DATE;
BEGIN
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."BORRAR_USUARIOS" (ID NUMBER)IS
BEGIN
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."DEVOLVER_LIBRO" (COD NUMBER)IS
BEGIN
...
/
--------------------------------------------------------
--  DDL for Procedure INSERTAR_LIBROS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INSERTAR_LIBROS" (CLASE NUMBER,PRESTADO NUMBER,GENERO VARCHAR2,AUTOR VARCHAR2,TITULO VARCHAR2,EDITOR VARCHAR2)IS
BEGIN
...
/
--------------------------------------------------------
--  DDL for Procedure INSERTAR_PRESTAMOS
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INSERTAR_PRESTAMOS" ( NUSER IN USUARIOS.NUM_CARNET%TYPE,
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."INSERTAR_USUARIOS" (NOMBRE VARCHAR2,CALLE VARCHAR2,CIUDAD VARCHAR2,COD_POST NUMBER)IS
BEGIN
...
set define off;
  ...
  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."PERDONAR_USUARIO" (id NUMBER) IS 
BEGIN
  UPDATE USUARIOS SET penalizado=0 WHERE num_carnet=id;
END PERDONAR_USUARIO;

/
--------------------------------------------------------
--  DDL for Package OBTENER_HISTORICO
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE "SYSTEM"."OBTENER_HISTORICO" 
AS
...
/
--------------------------------------------------------
--  DDL for Package OBTENER_LIBROS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE "SYSTEM"."OBTENER_LIBROS" 
AS
  TYPE cursor_1 IS REF CURSOR;
...
/
--------------------------------------------------------
--  DDL for Package OBTENER_PRESTAMOS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE "SYSTEM"."OBTENER_PRESTAMOS" 
AS
  TYPE cursor_1 IS REF CURSOR;
...
/
--------------------------------------------------------
--  DDL for Package OBTENER_USUARIOS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE "SYSTEM"."OBTENER_USUARIOS" 
AS
  TYPE cursor_1 IS REF CURSOR;
...
/
--------------------------------------------------------
--  DDL for Package Body OBTENER_HISTORICO
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "SYSTEM"."OBTENER_HISTORICO" 
IS
...
/
--------------------------------------------------------
--  DDL for Package Body OBTENER_LIBROS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "SYSTEM"."OBTENER_LIBROS" 
IS
...
/
--------------------------------------------------------
--  DDL for Package Body OBTENER_PRESTAMOS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "SYSTEM"."OBTENER_PRESTAMOS" 
IS
...
/
--------------------------------------------------------
--  DDL for Package Body OBTENER_USUARIOS
--------------------------------------------------------

  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "SYSTEM"."OBTENER_USUARIOS" 
IS
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."USUARIOS" ADD PRIMARY KEY ("NUM_CARNET")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."USUARIOS" ADD UNIQUE ("SYS_NC_OID$") RELY
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."HISTORICO" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PRESTAMOS" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."LIBROS" ADD PRIMARY KEY ("COD_LIBRO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."LIBROS" ADD UNIQUE ("SYS_NC_OID$") RELY
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
